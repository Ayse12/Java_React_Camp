...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(long tc, java.lang.String ad, java.lang.String soyad, int dogumYili) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(tc, ad, soyad, dogumYili);
  }
