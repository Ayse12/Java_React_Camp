...
public class Main {
	...
	public static void main(String[] args) {
		...
		User user1 = new User(1,"Ayþe","Ýlhanlý","12345","03.07.1998");
		User user2 = new User(2,"Sevda","Doðan","1234","23.03.2000");
		...
		Campaign campaign = new Campaign(1, "Yýlbaþý indirimi", 10, 1111111);
